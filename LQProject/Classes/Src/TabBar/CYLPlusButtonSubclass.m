...
+ (instancetype)plusButton {
    ...
    [button setImage:[UIImage imageNamed:@"shaoyishao"] forState:UIControlStateNormal];
    [button setImage:[UIImage imageNamed:@"shaoyishaoax"] forState:UIControlStateSelected];
...
- (void)clickPublish {
    UIViewController *vc = [UtilsApi initViewControllerWithClassName:@"MineTVC" inStoryboard:@"Mine"];
