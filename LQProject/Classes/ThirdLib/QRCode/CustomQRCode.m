...
+ (UIImage *)generateCustomQRCode:(NSString *)string andSize:(CGFloat)size andColor:(UIColor *)color {
    UIImage *qrcode = [CustomQRCode createNonInterpolatedUIImageFormCIImage:[CustomQRCode createQRForString:string] withSize:size];
    ...
    return [CustomQRCode imageBlackToTransparent:qrcode withRed:red andGreen:green andBlue:blue];
}
