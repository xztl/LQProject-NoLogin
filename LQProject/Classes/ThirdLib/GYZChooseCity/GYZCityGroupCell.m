...
- (UILabel *) titleLabel
{
    if (_titleLabel == nil) {
        ...
        _titleLabel.textColor = [UIColor colorWithRed:168.0/255.0 green:168.0/255.0 blue:168.0/255.0 alpha:1.0];
    }
    return _titleLabel;
}
...
- (UILabel *) noDataLabel
{
    if (_noDataLabel == nil) {
        ...
        [_noDataLabel setTextColor:[UIColor colorWithRed:90.0/255.0 green:90.0/255.0 blue:90.0/255.0 alpha:1.0]];
...
- (void) setCityArray:(NSArray *)cityArray
{
    ...
    for (int i = 0; i < cityArray.count; i ++) {
        ...
        if (i < self.arrayCityButtons.count) {
            ...
            [button setTitleColor:[UIColor colorWithRed:90.0/255.0 green:90.0/255.0 blue:90.0/255.0 alpha:1.0] forState:UIControlStateNormal];
            [button.titleLabel setFont:[UIFont systemFontOfSize:14.0f]];
            [button.layer setMasksToBounds:YES];
            [button.layer setCornerRadius:2.0f];
            [button.layer setBorderColor:[UIColor colorWithRed:220.0/255.0 green:220.0/255.0 blue:220.0/255.0 alpha:1.0].CGColor];
